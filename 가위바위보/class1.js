...
var obj = {
    a: function() {
        console.log('a: x =', x); // (3) 22번 줄 설명과 연결
        ...
        function a_sub() {
            console.log('a_sub: result =', result); // a 안에 선언된 함수이기에 외부 환경은 a가 된다 따라서 a에 선언된 result{value: 1}에 접근
...
function b(value) {
    ...
    return aResult.value + value; // aResult = return result(안에 value 존재)
}
